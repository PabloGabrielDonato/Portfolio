...
const about = {
  title: "Sobre mí",
  description: "breve descripcion sobre mi",

  info: [
    {
      fieldName: "Nombre",
      fieldValue: "Pablo Donato",
    },
    {
    ...
    {
      fieldName: "Email",
      fieldValue: "pablodonatoportfolio@gmail.com",
    },
    {
      fieldName: "Freelance",
...
const education = {
  ...
  items: [
    {
      institution: "Escuela multimedial DaVinci",
          ...
          <div className="min-h-[70vh] w-full">
                  ...
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {experience.items.map((item, index) => {
                      return (
                        <li
                          key={index}
                          className="bg-[#232329] h-[184px] py-6 px-10 rounded-xl flex flex-col justify-centeritemcen
            ...
            <TabsContent value="skills" className="w-full h-full">
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols-2 md:grid-cols-4 xl:gap-[30px] gap-4">
